...
python main.py --group_name finetune_single_point --save_name bc32_wd1e-3_adamW_samloss_1:2_lrdecay_iouloss0.05_center \
--batch_size 32  --weight_decay 1.e-3 --optimizer AdamW --promt_type single_point --center_point \
--use_embedded --weight_list 1 2 --loss sam_loss --lr_schedular StepLR --step_size 2000 \
--iou_scale 0.05 \
--gpu_id 0

python main.py --group_name finetune_single_point --save_name bc32_wd1e-3_adamW_samloss_2:1_lrdecay_iouloss0.05_center \
--batch_size 32  --weight_decay 1.e-3 --optimizer AdamW --promt_type single_point --center_point \
--use_embedded --weight_list 2 1 --loss sam_loss --lr_schedular StepLR --step_size 2000 \
--iou_scale 0.05 \
--gpu_id 0
