...
python main.py --group_name finetune_grid_points --save_name bc16_wd1e-3_adamW_samloss_1:1_lrdecay_iouloss0.05_12points \
--batch_size 16  --weight_decay 1.e-3 --optimizer AdamW --promt_type grid_points \
--use_embedded --weight_list 1 1 --loss sam_loss --lr_schedular StepLR --step_size 2000 \
--iou_scale 0.05 --point_num 12 \
--gpu_id 0


python main.py --group_name finetune_grid_points --save_name bc16_wd1e-3_adamW_samloss_1:1_lrdecay_warmup_iouloss0.05_16points \
--batch_size 16  --weight_decay 1.e-3 --optimizer AdamW --promt_type grid_points \
...
grid_points_16 80.03 log/finetune_grid_points/bc16_wd1e-3_adamW_samloss_1:1_lrdecay_iouloss0.05_16points/10.pth
